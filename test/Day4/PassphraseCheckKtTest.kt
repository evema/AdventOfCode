...
internal class PassphraseCheckKtTest {

    @Test
    fun countValidPhrasesWithoutDuplicatesTest() {

        assertEquals(2, countValidPhrasesWithoutDuplicates("aa bb cc dd ee\n" +
                "aa bb cc dd aa\n" +
                "aa bb cc dd aaa"))
    }

    @Test
    fun countValidPhrasesWithoutDuplicatesAdventOfCodeTest() {

        assertEquals(383, countValidPhrasesWithoutDuplicates(inputAdventOfCode))
    }

    @Test
    fun countValidPhrasesWithoutAnagramsTest() {
        assertEquals(3, countValidPhrasesWithoutAnagrams("""abcde fghij
abcde xyz ecdab
...
oiii ioii iioi iiio"""
    ...
    @Test
    fun countValidPhrasesWithoutAnagramsAdventOfCodeTest() {
        assertEquals (265, countValidPhrasesWithoutAnagrams(inputAdventOfCode))
    }

    private val inputAdventOfCode = """sayndz zfxlkl attjtww cti sokkmty brx fhh suelqbp
